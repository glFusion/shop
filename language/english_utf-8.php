...
'adm_mnu_region' => 'Purchases and shipping will be complegely disallowed for any region, country, or state that is disabled. Optional check one or more regions to add to a rule.',
'adm_mnu_states' => 'Disable any state for which sales should be disallowed.<br />You can also indicate whether a state charges sales tax on shipping and/or handling charges (applies to USA only).',
'redacted' => 'Redacted',
'reject' => 'Reject',
'approve' => 'Approve',
...
'hlp_rules_noitems' => 'One or more of the items on your order have been highlighted and are not available to your location.<br />Please edit the order to remove the items or change the shipping information.',
...
'discount_codes' => 'Discount codes are reusable codes for the buyer to enter at checkout to obtain a discount. Codes can be valid during a date range and can require a minimum order value.',
...
$LANG_configSelect['shop'] = array(
    ...
    14 => array(0 => 'Not Available', 1 => 'Optional', 2 => 'Required'),
    15 => array('lbs' => 'Pounds', 'kgs' => 'Kilograms'),
    16 => array(

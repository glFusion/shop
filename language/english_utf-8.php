...
'adm_mnu_states' => 'Disable any state for which sales should be disallowed.<br />You can also indicat whether a state charges sales tax on shipping and/or handling charges (USA only).',
'redacted' => 'Redacted',
'reject' => 'Reject',
'approve' => 'Approve',

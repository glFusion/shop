 ...
 * Installed by Shop v1.5.0 upgrade to ensure function declarations
 * are compatible with the base class.
 *
...
// Most of these are not needed, but better safe...
...
class Gateway extends \Shop\Gateway
{
     ...
     */
    public function thanksVars(array $A=array()) : array
    {
        $R = array(
     ...
     */
    public function _genHash(string $text) : string
    {

<?php
/**
 * Data structure class for payouts.
 *
...
class Payout implements \ArrayAccess
{
    ...
    private $properties = array(
        'type'      => 'general',   // Payout description
        'uid'       => 0,       // glFusion user ID to receive the payment
        'email'     => '',      // Recipient's email address
        'method'    => '',      // Gateway to use
        'amount'    => 0,       // Amount to pay
        'currency'  => 'USD',   // Payment currency
        'txn_id'    => '',      // Transaction ID, filled in once fulfilled
        'message'   => '',      // Note to the recipient
        'parent_id' => NULL,
    );

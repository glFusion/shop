...
'hlp_prv_key' => 'Enter the complete path to your private SSL key file. This file <b>must</b> be readable by your web server and should <b>not</b> be placed in a publically-accessible directory. The security of your encrypted PayPal buttons depends upon this key remaining private.',
'hlp_pub_key' => 'Enter the complete path to the public SSL key file that you&apos;ve provided to Paypal. This file <b>must</b> be readable by your web server and should <b>not</b> be placed in a publically-accessible directory, despite its name.',
...
'hlp_pp_cert' => 'Enter the complete path to the public SSL certificate file that you\'ve downloaded from Paypal. This file should <b>not</b> be under your web root but <b>must</b> be readable by your web server.',

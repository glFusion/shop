...
Log::write('shop_system', "Got Webhook Headers: " . var_export($_SERVER,true));
Log::write('shop_system', "Got Webhook GET: " . var_export($_GET, true));
Log::write('shop_system', "Got Webhook POST: " . var_export($_POST, true));
Log::write('shop_system', "Got php:://input: " . var_export(@file_get_contents('php://input'), true));
